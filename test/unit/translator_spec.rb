        ...
        main(
          s(:asgn,
                ...
                s(:asgn,
                  s(:binary_oper, :'.',
                    s(:indexer,
                      s(:var, :"M_Object_words"), s(:var, :var1)),
                    s(:var, :function)),
    ...
    translate_code('def fun; 5; end; fun; fun')[1..3].should ==
      [s(:file,
        ...
        main(
          ...
          s(:asgn, s(:var, :var2), s(:call, :"M_Object_fun", s(:args, s(:var, :self)))),
          decl(:var3),
          s(:asgn, s(:var, :var3), s(:call, :"M_Object_fun", s(:args, s(:var, :self))))))]
  end
      ...
      [s(:file,
       ...
       s(:file,
        ...
        main(
          ...
          decl(:var2),
          s(:asgn, s(:var, :var2), s(:call, :"M_Object_fun_Fixnum",
        ...
        s(:defn,
         ...
         s(:block,
          ...
          s(:asgn,
           s(:binary_oper,
            :".",
            s(:indexer, s(:var, :A_words), s(:var, :var1)),
            s(:var, :function)),
