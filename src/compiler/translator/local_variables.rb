class Translator
  ...
  module LocalVariables
    ...
    def translate_lasgn(sexp)
      ...
      filtered_stmts(arg, s(:asgn, s(:var, esc_name), arg.value_sexp))
      .with_value(s(:var, esc_name), arg.value_type)
    end
    ...
    def translate_lvar(sexp)
      ...
      s(:stmts).with_value(s(:var, esc_name), @symbol_table.get_lvar_type(sexp[1]))
    end
  end
end
